    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <p><em>Propostas de Logotipo</em></p>

            <p><em><strong>Cliente:</strong> PV Eventos,
			    <strong>Agência:</strong>Vislumbre, <strong>Trabalho: </strong>Design Gráfico
            </em></p>

		  </div>
		    <img src="images/pv/01.jpg" width="579" height="410" /><br />
            <br />
            <img src="images/pv/02.jpg" width="579" height="821" /></div>
        <!--end corpo_box2-->
