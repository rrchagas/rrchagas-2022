    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <p><em>Convite de casamento para Nilo e Karina</em></p>

            <p><em><strong>Agradecimentos</strong><br/>
            Sandro Ramos</em>
            </em></p>

			<p><em><strong>Cliente:</strong> Karina &amp; Nilo,
			<strong>Agência:</strong> Vislumbre, <strong>Trabalho: </strong>Design Gráfico
            </em></p>
</div>
		    <img src="images/niloekarina/convite1.png" width="600" height="600" /></div>
        <!--end corpo_box2-->
