    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <p><em><strong>
            <a href="http://www.livrariascuritiba.com.br" target="_blank" class="url" > http://www.livrariascuritiba.com.br</a>
            </strong></em>
          <p/>
            
          <p><em>Criação de Landing Page para o dia dos namorados e para o dia das mães, como foco nos produtos em promoção<br />
          </em><em> onde o usuário tivesse participação e informações relevantes 
          sobre o dia, além de dar destaque com apelo visual</em><br />
          <em>aos casais mais famosos relacionados com produtos;</em></p>
          <p><em> </em><em><strong>Agradecimentos</strong><br/>
          Luciane Laskoski</em>            </p>
          <p><em><strong>Cliente:</strong> Livrarias Curitiba,
			<strong>Agência:</strong> WV, <strong>Trabalho: </strong>Direção de Arte / Design de Interface<br />
			</em></p>
</div>
		    <img src="images/livrarias/layout_lc01.jpg" />
		    <img src="images/livrarias/layout_lc02.jpg" />
		    <img src="images/livrarias/layout_lc03.jpg" />
		    <img src="images/livrarias/layout_lc04.jpg" />        </div>
        <!--end corpo_box2-->
