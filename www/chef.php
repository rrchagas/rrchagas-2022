    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <h1>chef guisakai</h1>
            <p><em><strong>
           <a href="http://www.chefguisakai.com" target="_blank" class="url"  title="Chef GuiSakai"> http://www.chefguisakai.com</a></strong></em>
            <p/>
            <em>Site do Chef de Cozinha Gui Sakai</em><em>;</em>
            
            <p><em><strong>Agradecimentos</strong><br/>
            © Morgan David de Lossy/Corbis  - Luis Cardoso</em>            </p>

			<p><em><strong>Cliente:</strong> GUISAKAI,
			<strong>Agência:</strong>Vislumbre, <strong>Trabalho: </strong>Design de Interface / Layout;</em></p>
			<p>&nbsp;</p>
			<p><em><br />
		    </em></p>
	      </div>
