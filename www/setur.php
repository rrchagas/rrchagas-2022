    ...
    <div id="corpo">    	<!--go corpo_box1-->
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <h1>setur</h1>
          <p><em><strong>
          <a href="http://www.espalheminas.com.br" target="_blank" class="url" > http://www.espalheminas.com.br</a>
            </strong></em>
          <p/>
            
          <p><em>Criação de layout para o novo portal ESPALHE MINAS, como também criação do perfil para twitter e <a href="http://www.youtube.com/espalheminas" target="_blank" title="ESPALHE MINAS YOUTUBE">youtube</a></em><em>;</em></p>
          <p><em> </em><em><strong>Agradecimentos</strong><br/>
          Luciana Braga / Terra Forum</em></p>
          <p><em><strong>Trabalho: </strong>Layout/Design de Interface/<br />
			</em></p>
</div>
           <p><br />
             <br />
             <img src="images/setur/layout.jpg" />           </p>
           <p>&nbsp;</p>
           <p><img src="images/setur/layout01_home.jpg" width="579" height="1177" /> </p>
           <p>&nbsp;</p>
           <p><img src="images/setur/layout02_03.jpg" width="579" height="1221" /></p>
      </div>
        <!--end corpo_box2-->
