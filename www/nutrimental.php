    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <h1>nutrimental</h1>
            <p><em><strong>
            <a href="http://www.nutryseussonhos.com.br" target="_blank" class="url" > http://www.nutryseussonhos.com.br</a>
            </strong></em><p/>
            
          <p><em>O projeto era adaptar um projeto gráfico da promoção com foco em PDV</em> <em>e criar um Hotsite onde pudessemos
            <br/>
            atingir 3 tipos de perfis da promoção.</em></p>
            <p><em> Além de estimular a participação na promoção, estimulamos a participação 
            do usuário não só na promoção</em><br />
            <em>mas com ferramentas onde ele poderia publicar seu sonho, 
            e convidar outros para participar da promoção;</em></p>
            <p><em><strong>Agradecimentos</strong><br/>
            Louisiane Laskoski, Renato Lovizotto</em></p>

			<p><em><strong>Cliente:</strong> Nutrimental,
			<strong>Agência:</strong> WV, <strong>Trabalho: </strong>Design de Interface<br />
			</em></p>
</div>
    <img src="images/nutrimental/layout_nutry01.jpg" />
		    <img src="images/nutrimental/layout_nutry02.jpg" />
		    <img src="images/nutrimental/layout_nutry03.jpg" />
		    <img src="images/nutrimental/layout_nutry04.jpg" />                        
		    <img src="images/nutrimental/layout_nutry05.jpg" />
		    <img src="images/nutrimental/layout_nutry06.jpg" />                        
