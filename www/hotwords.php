    ...
    <div id="corpo">    	<!--go corpo_box1-->
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <h1>hotwords</h1>
          <p><em><strong>
          <a href="http://www.hotwords.com.br" target="_blank" class="url" > http://www.hotwords.com.br</a>
            </strong></em>
          <p/>
            
          <p><em>Criação de layout para o novo portal Institucional </em><em>;</em></p>
          <p><em> </em><em><strong>Agradecimentos</strong><br/>
          Diego Sella, Gustavo Morale, Thiago Cassini e Marco Aurélio</em></p>
          <p><em><strong>Trabalho: </strong>Layout/Design de Interface/  Produção XHMTL + CSS<br />
			</em></p>
</div>
      <img src="images/hotwords/tela01.jpg" title="Reformulação do Portal Institucional" />
      <br />
      <br />
      <img src="images/hotwords/tela01.jpg" title="Reformulação do Portal Institucional" />      
      </div>
