    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <h1>projeto story board</h1>
            <p><em><strong>offline</strong></em><br/></p>
            
            <p><em>Projeto Acadêmico de Story Board;</em></p>
            <p><em><strong>Agradecimentos</strong><br/> 
              Fernando Claderari e Ingo;
</em></p>
            <p><em><strong>Cliente:</strong> PUC PR,
		    ...
		    <br />
            <br />
            <img src="images/storyboard/f0.jpg" /><br />
            <br />
            <img src="images/storyboard/f1.jpg"  /><br />
            <br />
            <img src="images/storyboard/f2.jpg"  /><br />
            <br />
            <img src="images/storyboard/f3.jpg" /></div>
        <!--end corpo_box2-->
