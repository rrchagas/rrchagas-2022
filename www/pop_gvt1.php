    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <h1>pop/gvt</h1>
            <p><em><strong><a href="http://www.pop.com.br/promocao" target="_blank" class="url" >http://www.pop.com.br/promocao</a></strong></em><br/> 
            <br />
          <p><em>Adaptação de novo layout a uma plataforma de programação já existente em php</em><em>;</em></p>
            ...
            João Sousa e Taukane</em></p>

			<p><em><strong>Cliente:</strong> GVT,
			<strong>Agência:</strong> Binworks, <strong>Trabalho: </strong>Produção  PHP + XHTML+ CSS <br />
			</em></p>
</div>
      <img src="images/pop_gvt/layout_pop00.jpg" />
		    <img src="images/pop_gvt/layout_pop01.jpg" />            
