    ...
    <div id="corpo">
        ...
        <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            <h1>sebrae - sc </h1>
            <p><em><strong>
            <a href="http://www.cristianismohoje.com.br" target="_blank" class="url" title="Cristianismo Hoje" >mobile off</a></strong></em><br/>
            </p>
            
            <p><em>Layout desenvolvido para projeto mobile para o SEBRAE -SC</em></p>

            <p><em><strong>Agradecimentos</strong><br/>
            Bruno, Paulo e Eduardo</em></p>

			<p><em><strong>Cliente:</strong> Sebrae - SC
			<strong>Agência:</strong> E-Deploy <strong>Trabalho: </strong>Layout</em></p>
		  </div>




  <p style="font-size:13px; font-style:normal;"><img src="images/SEBRAE/layout_00a.png" width="500" height="950" /><br />
    <img src="images/SEBRAE/layout_00c.png" width="500" height="950" /></p>
  <p style="font-size:13px; font-style:normal;"><img src="images/SEBRAE/layout_02.png" width="500" height="950" /></p>
      </div>
