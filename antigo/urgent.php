    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <h1>urgente medical care</h1>
          <p><em><strong>offline</strong></em><br/> 
            <br />
          <p><em>Desenvolvimento de layout, para hospital em Pompano Beach, Miami.</em> </p>
          <p><em><strong>Agradecimentos</strong><br/>
          Charles Gomes</em></p>

			<p><em><strong>Cliente:</strong> Urgente Medical Care,
			<strong>Agência:</strong> Vislumbre, <strong>Trabalho: </strong>Design Interativo <br />
			</em></p>
</div>
		    <img src="images/urgent/layout_urgent01.jpg" />
		    <img src="images/urgent/layout_urgent02.jpg" />
        </div>
        <!--end corpo_box2-->
