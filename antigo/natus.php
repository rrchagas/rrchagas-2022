    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
	      ...
	      <div id="corpo_box2_01">
            ...
            <p><em>Identidade Visual para a agência de tecnologia;</em></p>

            <p><em><strong>Agradecimentos</strong><br/>
            Thiago Oliveira</em>
            </em></p>

			<p><em><strong>Cliente:</strong> Natus Tecnologia,
			<strong>Agência:</strong> Vislumbre, <strong>Trabalho: </strong>Design Gráfico
            </em></p>
</div>
           <p><img src="images/natus/composicao_natus01_1600.jpg" /></p>
           <p>&nbsp;</p>
           <p><img src="images/natus/composicao_natus02_1600.jpg" width="579" height="337" /> </p>
        </div>
        <!--end corpo_box2-->
