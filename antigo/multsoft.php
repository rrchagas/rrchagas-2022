    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <p><em>Desenvolvimento e conceitualização de logotipo para empresa que atua no mercado de desenvolvimento<br />
de softwares;</em></p>
			...
			<p><em><strong>Cliente:</strong> MulSoft,
			<strong>Agência:</strong> Vislumbre, <strong>Trabalho: </strong>Design Gráfico
            </em></p>
</div>
		    <img src="images/multsoft/multsoft_01.jpg" /></div>
        <!--end corpo_box2-->
