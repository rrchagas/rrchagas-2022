...
<!--go corpo-->
    <div id="corpo">
        ...
        <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            <h1>adega bolevard </h1>
            <p><em><strong>
            <a href="http://www.cristianismohoje.com.br" target="_blank" class="url" title="Cristianismo Hoje" >off</a></strong></em><br/>
            </p>
            
            <p><em>Wireframe desenvolvido para ecommerce de uma adega de vinhos.</em></p>

            <p><em><strong>Agradecimentos</strong><br/>
            Felipe Feliz</em></p>

			<p><em><strong>Cliente:</strong> Adega Bolevard,
			<strong>Agência:</strong> Vislumbre <strong>Trabalho: </strong>Wireframe
            </em></p>
		  </div>
  ...
  <p style="font-size:13px; font-style:normal;"><img src="images/adega/layout03.jpg" width="579" height="893" /></p>
      </div>
