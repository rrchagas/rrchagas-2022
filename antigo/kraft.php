    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <h1>kraft foods</h1>
            <p><em><strong>
          <a href="http://www.nutryseussonhos.com.br" target="_blank" class="url" > offline</a></strong></em>
            <p/><em>Proposta para o HotSite do Sonho de Valsa para o dia dos namorados</em><em>;</em>
            
          <p><em><strong>Agradecimentos</strong><br/>
            Marcelo Cuco</em>
            </p>

			<p><em><strong>Cliente:</strong> Kraft Foods,
			<strong>Agência:</strong> inMídia Web/Plow , <strong>Trabalho: </strong>Design Interativo / Interface<br />
			</em></p>
</div>
		    <img src="images/kraft/layout_kraft01.jpg" /></div>
        <!--end corpo_box2-->
