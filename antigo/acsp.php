    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <h1>acsp (em andamento)</h1>
          <p><em><strong>
          <a href="http://www.acsp.com.br" target="_blank" class="url"  title="Projeto **voltamuricy"> http://www.acsp.com.br</a>
            </strong></em>
          <p/><em>O projeto tem como objetivo utilizar técnica</em><em>s que facilite a navegação do usuário e ainda estamos estudando e trabalhando no projeto;</em>
          <p/>
          <p><em><strong>Trabalho: </strong>Layout/Design de Interface/ Layout /  Produção XHMTL + CSS</em></p>
          <p>&nbsp;</p>
          <p><em><img src="images/acsp/LAYOUT_FECHADO.jpg" width="579" height="1158" /><br />
            <br />
            <br />
            <img src="images/acsp/LAYOUT_FECHADO_INTERNA_CONTEUDO.jpg" width="579" height="1158" /><br />
            </em>
