    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <p><em>Vinheta para Rádio Bandeirantes para o estádio</em> Morumbi;</p>

            <p><em><strong>Agradecimentos</strong><br/>
            Renato Nascimento</em></p>

			<p><em><strong>Cliente:</strong> Rádio Bandeirantes,
			<strong>Agência:</strong>Orange/Vislumbre, <strong>Trabalho: </strong>Design Gráfico
            </em></p>
</div>
		    <img src="images/radiobandeirantes/layout_vinhetas_02.jpg" width="579" height="717" /></div>
        <!--end corpo_box2-->
