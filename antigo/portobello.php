    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <h1>hotsite portobello</h1>
            <p><em><strong><a href="http://www.portobello.com.br" target="_blank" class="url" >http://www.portobello.com.br</a></strong></em><br/>
                <br />
            </p>
            <p><em>Adaptação de novo layout a uma plataforma de programação já existente em php</em><em>;</em></p>
<p><em><strong>Agradecimentos</strong><br/>
              Renato Nascimento</em></p>
            <p><em><strong>Cliente:</strong> Portobello, <strong>Agência:</strong>Orange Design, <strong>Trabalho: </strong>Layout e Programação Flash;</em></p>
            <p>&nbsp;</p>
            <p><em><img src="images/portobello/home_carrega.jpg" width="579" height="385" /></em><br />
              <br />
              <img src="images/portobello/afinestre.jpg" width="579" height="385" /><br />
              <br />
              <img src="images/portobello/produtos.jpg" width="579" height="385" /></p>
	      </div>
      <br />
      <br />
      </div>
