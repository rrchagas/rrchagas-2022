...
<!--go corpo-->
    ...
    <h1>nova terra geoprocessamento</h1>
          <p><em><strong>
          <a href="http://www.novaterrageo.com.br/" target="_blank" class="url" > http://www.novaterrageo.com.br/</a>
            </strong></em>
          <p/>
            
          <p><em>Criação de layout para o site institucional da Nova Terra, projeto focado no usuário, e na tecnologia<br />
          aplicada para o design;</em><em></em></p>
          <p><em> </em><em><strong>Agradecimentos</strong><br/>
          Nova Terra</em>            </p>
          <p><em><strong>Cliente:</strong> Nova Terra Geoprocessamento,
<strong>Agência:</strong>WV, <strong>Trabalho: </strong>Design Interativo /  Produção XHMTL + CSS<br />
			</em></p>
            
            </div>
		    <img src="images/novaterra/layout_nt01.jpg" />
		    <img src="images/novaterra/layout_nt02.jpg" />
		    <img src="images/novaterra/layout_nt03.jpg" />            </div>
        <!--end corpo_box2-->
