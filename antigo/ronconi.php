    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <h1>ronconi</h1>
          <p><em><strong><a href="http://www.ronconi.com.br" target="_blank" class="url" >http://www.ronconi.com.br</a></strong></em><br/> 
            <br />
          <p><em>Desenvolvimento de layout e conteúdo para site da Ronconi 2004.</em> </p>
          <p><em><strong>Agradecimentos</strong><br/>
          Sandro Ramos</em></p>

			<p><em><strong>Cliente:</strong> Ronconi,
			<strong>Agência:</strong> inMídia Web, <strong>Trabalho: </strong>Design Interativo <br />
			</em></p>
</div>
		    <img src="images/ronconi/layout_01.jpg" /></div>
        <!--end corpo_box2-->
