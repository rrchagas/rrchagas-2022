...
<!--go corpo-->
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
			...
			<h1>**voltamuricy</h1>
			<p><em><strong>
			<a href="http://www.voltamuricy.com.br" target="_blank" class="url"  title="Projeto **voltamuricy"> 		http://www.voltamuricy.com.br</a>
            </strong></em>
          <p/>
          
          <p>Criação e veiculação do site que estourou no  meio esportivo, resultado?<br />

           <!--  Mais de 4mil camisetas vendidas em menos de 15dias</span>-->
          Mais de 500mil visitas de torcedores doentes pelo São Paulo.</em>          
          Mídia espontânea nos principais meios de comunicação,(Globo, Band, Gazeta Esportiva, ESPN,Lance,Placar..) atingindo Rádio, Tv, Impresso e Web.
          </em>
          <p><em> </em><em><strong>Agradecimentos e Créditos</strong><br/>
          Luis Cardoso, Cibele Cardoso e Robson R.</em></p>
      <p><em><strong>Trabalho: </strong>Layout/Design de Interface/  Produção XHMTL + CSS<br />
			</em></p>
      ...
      <img src="images/voltamuricy/layout_01.jpg" title="Projeto **voltamuricy" />
      <br />
      <br />
      </div>
        <!--end corpo_box2-->
