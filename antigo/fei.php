    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <p><em><strong>
            <a href="http://www.nutryseussonhos.com.br" target="_blank" class="url" > off-line</a></strong></em>
            <p/><em>Proposta de layout para o portal da faculdade FEI</em><em>;</em>
            
        <p><em><strong>Agradecimentos</strong><br/>
            Renato Nascimento</em>
            </p>

			<p><em><strong>Cliente:</strong> FEI,
			<strong>Agência:</strong> Orange Design, <strong>Trabalho: </strong>Design de Interface / Layout<br />
			</em></p>
</div>
    <img src="images/fei/layout_01.jpg" /><img src="images/fei/layout_02.jpg" /><img src="images/fei/layout_03.jpg" />
		    <img src="images/fei/layout_04.jpg" />                        
		    <img src="images/fei/layout_05.jpg" /></div>
        <!--end corpo_box2-->
