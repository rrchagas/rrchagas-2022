    ...
    <div id="corpo">
        ...
        <div id="corpo_box2">            <a href="index.html" title="Home" class="home">home</a><br /><br />
		   ...
		   <div id="corpo_box2_01">
            ...
            <h1>lupo em casa</h1>
          <p><em><strong>
          <a href="http://www.lupoemcasa.com.br" target="_blank" class="url" > http://www.lupoemcasa.com.br</a>
            </strong></em>
          <p/>
            
          <p><em>Criação de layout para o novo e-commerce da Lupo</em><em>;</em></p>
          <p><em> </em><em><strong>Agradecimentos</strong><br/>
          Thiago Cassini, Nuriene</em>            </p>
          <p><em><strong>Cliente:</strong> Lupo,
<strong>Agência:</strong>Pixcomm, <strong>Trabalho: </strong>Design Interativo /  Produção XHMTL + CSS<br />
			</em></p>
</div>
      <img src="images/lupo/layout_lupoemcasa.jpg" /></div>
        <!--end corpo_box2-->
